<template>
  <div class="shop-header">
    ...
    <div class="shop-content"  @click="shopShowHandler">
      <img class="content-image" :src="info.avatar">
      <div class="header-content">
        <h2 class="content-title">
          <span class="content-tag">
          <span class="mini-tag">品牌</span></span><span class="content-name">{{info.name}}</span><i class="content-icon"></i>
        </h2>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="showDiscountsHandler">
      <div class="discounts-left">
        <div class="activity activity-green"><span class="content-tag"><span class="mini-tag">{{info.supports[0].name}}</span></span>
    ...
    <div class="shop-brief-modal" v-show="shopShow">
      <div class="brief-modal-content" >
        ...
        <div class="mask-footer">
          <span class="iconfont icon-guanbi" @click="shopShowHandler"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="showDiscounts">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-guanbi" @click="showDiscountsHandler"></span>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      showDiscountsHandler(){
        this.showDiscounts=!this.showDiscounts;
      }
    },
  mounted() {
      this.$store.dispatch("receiveInfos")
    },
    computed: {
      ...mapState(['info'])
    }
